...
export interface FishBaseData {
  ...
  bait: string;
  line_mm: number;
  /** Braid diameter in mm — only set where braid is common practice (spinning for predators) */
  braid_mm?: number;
  hook_size: string;
  lures?: string;
  rigs: string;
...
export interface FishSpecies {
  ...
  techniqueData?: {
    [technique: string]: {
      ...
      bait?: string;
      line_mm?: number;
      /** Braid diameter in mm — only set for spinning entries where braid is standard practice */
      braid_mm?: number;
      hook_size?: string;
      rigs?: string;
      lures?: string;
...
export const FISH_DATABASE: FishSpecies[] = [
  ...
  },
  {
    ...
    techniqueData: {
      'Поплавък': { groundbait: 'Технопланктон, фитопланктон смес', bait: 'Технопланктон, тесто с планктон, водорасли, хляб', line_mm: 0.25, hook_size: '4-8', rigs: 'Тремпел монтаж, плаващ монтаж' },
    },
  ...
  },
  {
    ...
    techniqueData: {
      'Спининг': { bait: 'Голяма жива риба, черен дроб', line_mm: 0.40, braid_mm: 0.35, hook_size: '2/0-4/0', lures: 'Големи силиконови примамки, воблери 12-20см', rigs: 'Дънен монтаж с тежка тежест' },
  ...
  },
  {
    ...
    techniqueData: {
      'Спининг': { bait: 'Жива рибка, мъртва рибка', line_mm: 0.30, braid_mm: 0.20, hook_size: '2-4', lures: 'Воблери 7-15см, спинери, блесни', rigs: 'Стоманен повод, спининг монтаж' },
    },
    ecoRed: '⛔ Забранен: зависи от място',
  ...
  },
  {
    ...
    techniqueData: {
      'Поплавък': { groundbait: 'Сладка финна захранка', bait: 'Червей, бял червей, царевица', line_mm: 0.14, hook_size: '12-16', rigs: 'Лек поплавъчен монтаж' },
      'Фидер':    { groundbait: 'Финна сладка захранка', bait: 'Червей, бял червей', line_mm: 0.16, hook_size: '12-14', rigs: 'Лек фидер монтаж' },
    },
    ecoRed: '⛔ Забранен: зависи от място',
  ...
  },
  {
    ...
    baseData: {
      ...
      bait: 'Бял червей, малък червей, тесто, хляб',
      line_mm: 0.10,
      hook_size: '18',
    ...
    techniques: { lake: ['Поплавък'], river: ['Поплавък'] },
    techniqueData: {
      'Поплавък': { groundbait: 'Финна захранка с конопено семе, малки порции', bait: 'Бял червей, малък червей, тесто, хляб', line_mm: 0.10, hook_size: '18-20', rigs: 'Ваглер с тънък повод, ултралек поплавъчен монтаж' },
    },
    ecoRed: '⛔ Забранен: зависи от място',
    ecoGreen: '✅ Мин. размер: 15см',
    altitudeBans: {
  ...
  },
  {
    ...
    techniqueData: {
      'Спининг':  { bait: 'Малки воблери, блесни, силикон', line_mm: 0.14, braid_mm: 0.08, hook_size: '6-10', lures: 'Воблери 3-7см, въртящи блесни', rigs: 'Лек спинингов монтаж' },
      'Муха':     { bait: 'Сухи мухи, нимфи, мокри мухи', line_mm: 0.12, hook_size: '12-18', rigs: 'Мухарски монтаж с шнур и лидер' },
      'Поплавък': { bait: 'Червей, ларви, бял червей', line_mm: 0.14, hook_size: '10-14', rigs: 'Лек поплавъчен монтаж' },
    },
  ...
  },
  {
    ...
    spawnMonths: [4, 5],
    minSize: 25,
    techniques: { lake: ['Поплавък', 'Фидер'], river: ['Поплавък', 'Спининг'] },
    techniqueData: {
      'Поплавък': { groundbait: 'Хлебна захранка, варено жито', bait: 'Хляб, тесто, червеи', line_mm: 0.14, hook_size: '12-16', rigs: 'Лек поплавъчен монтаж' },
      'Фидер':    { groundbait: 'Хлебна захранка', bait: 'Тесто, хляб, червеи', line_mm: 0.16, hook_size: '10-14', rigs: 'Лек фидер монтаж' },
      'Спининг':  { bait: 'Малки воблери, спинери', line_mm: 0.16, braid_mm: 0.08, hook_size: '8-12', lures: 'Малки воблери 3-5см, спинери', rigs: 'Лек спинингов монтаж' },
    },
  ...
  },
  {
    ...
    spawnMonths: [4, 5],
    minSize: 20,
    techniques: { lake: [], river: ['Поплавък', 'Фидер'] },
    techniqueData: {
      'Поплавък': { groundbait: 'Каменна захранка, тежка смес', bait: 'Червеи, ларви, рачета', line_mm: 0.14, hook_size: '10-14', rigs: 'Болонезе, проводка' },
      'Фидер':    { groundbait: 'Речна тежка захранка', bait: 'Червеи, ларви', line_mm: 0.16, hook_size: '10-12', rigs: 'Лек фидер монтаж' },
    },
    ecoRed: '⛔ Забранен: 15.04 – 31.05',
  ...
  },
  {
    ...
    techniques: { lake: ['Поплавък', 'Фидер'], river: ['Поплавък'] },
    techniqueData: {
      'Поплавък': { groundbait: 'Финна сладка захранка', bait: 'Червей, бял червей, хляб', line_mm: 0.14, hook_size: '12-14', rigs: 'Лек поплавъчен монтаж' },
      'Фидер':    { groundbait: 'Финна захранка', bait: 'Червей, бял червей', line_mm: 0.16, hook_size: '12-14', rigs: 'Лек фидер монтаж' },
    },
    ecoRed: '⛔ Забранен: зависи от място',
    ecoGreen: '✅ Мин. размер: 20см',
    altitudeBans: {
  ...
  // ——— 9 NEW SPECIES ———
  {
    ...
    techniqueData: {
      'Спининг':  { bait: 'Малки воблери 3-7см, спинери, силикон', line_mm: 0.18, braid_mm: 0.06, hook_size: '4-8', lures: 'Воблери, спинери, туистери', rigs: 'Спинингов монтаж' },
  ...
  },
  {
    ...
    baseData: {
      ...
      bait: 'Червеи, бял червей, царевица, тесто',
      line_mm: 0.16,
      hook_size: '10',
    ...
    techniques: { lake: ['Фидер', 'Поплавък'], river: ['Фидер', 'Поплавък'] },
    techniqueData: {
      'Фидер':    { groundbait: 'Финна захранка с червей', bait: 'Червей, бял червей', line_mm: 0.16, hook_size: '10-14', rigs: 'Фидер монтаж с кратък повод' },
      'Поплавък': { groundbait: 'Финна захранка', bait: 'Червей, бял червей', line_mm: 0.14, hook_size: '12-16', rigs: 'Болонезе монтаж' },
    },
    ecoRed: '⛔ Забранен: зависи от място',
    ecoGreen: '✅ Мин. размер: 20см',
    altitudeBans: {
  ...
  },
  {
    ...
    baseData: {
      ...
      bait: 'Бял червей, червей, малка царевица, тесто',
      line_mm: 0.12,
      hook_size: '14',
    ...
    techniques: { lake: ['Поплавък'], river: ['Поплавък'] },
    techniqueData: {
      'Поплавък': { groundbait: 'Ситна захранка с конопено семе', bait: 'Бял червей, червей, малка царевица, тесто', line_mm: 0.12, hook_size: '14-16', rigs: 'Ваглер, фидер с тънък повод 0.08мм' },
    },
    ecoRed: '⛔ Забранен: зависи от място',
    ecoGreen: '✅ Мин. размер: 15см',
    altitudeBans: {
  ...
  },
  {
    ...
    baseData: {
      ...
      bait: 'Бял червей, малки мухи, хляб, тесто',
      line_mm: 0.12,
      hook_size: '14',
    ...
    techniques: { lake: ['Поплавък'], river: ['Поплавък'] },
    techniqueData: {
      'Поплавък': { groundbait: 'Лека повърхностна захранка', bait: 'Бял червей, малки мухи, хляб, тесто', line_mm: 0.12, hook_size: '14-18', rigs: 'Ваглер, повърхностен монтаж' },
    },
    ecoRed: '⛔ Забранен: зависи от място',
    ecoGreen: '✅ Мин. размер: 12см',
    altitudeBans: {
  ...
  },
  {
    ...
    techniqueData: {
      'Поплавък': { groundbait: 'Без захранка или минимална', bait: 'Червей, бял червей, тесто', line_mm: 0.16, hook_size: '8-12', rigs: 'Метод "на куршум", поплавъчен монтаж' },
      'Муха':     { bait: 'Утежнена нимфа, мокра муха', line_mm: 0.12, hook_size: '12-16', rigs: 'Мухарски монтаж' },
      'Фидер':    { groundbait: 'Речна захранка', bait: 'Червей, бял червей', line_mm: 0.18, hook_size: '10-14', rigs: 'Лек фидер монтаж' },
    },
    ecoRed: '⛔ Забранен: зависи от място',
    ecoGreen: '✅ Мин. размер: 25см',
    altitudeBans: {
  ...
  },
  {
    ...
    techniqueData: {
      'Спининг':  { bait: 'Малки воблери, блесни, силикон', line_mm: 0.14, braid_mm: 0.08, hook_size: '6-10', lures: 'Воблери 3-7см, въртящи блесни', rigs: 'Лек спинингов монтаж' },
      'Поплавък': { bait: 'Червей, ларви, бял червей, скариди', line_mm: 0.14, hook_size: '10-14', rigs: 'Лек поплавъчен монтаж' },
    },
  ...
  },
  {
    ...
    techniques: { lake: ['Спининг', 'Поплавък'], river: ['Спининг', 'Поплавък'] },
    techniqueData: {
      'Спининг':  { bait: 'Малки воблери, силикон', line_mm: 0.14, braid_mm: 0.06, hook_size: '8-12', lures: 'Микро джигове 1-3г, малки туистери, воблери до 5см', rigs: 'Ултралайт спининг, дроп-шот монтаж' },
      'Поплавък': { bait: 'Малки червеи, личинки', line_mm: 0.12, hook_size: '12-16', rigs: 'Лек поплавъчен монтаж с малка тежест' },
    },
    ecoRed: '⛔ Забранен: зависи от място',
    ecoGreen: '✅ Мин. размер: 12см',
    altitudeBans: {
  ...
  },
  {
    ...
    techniques: { lake: ['Спининг'], river: ['Спининг'] },
    techniqueData: {
      'Спининг': { bait: 'Живец (уклей, бабушка до 10см), мъртва рибка', line_mm: 0.28, braid_mm: 0.12, hook_size: '1/0-2/0', lures: 'Воблери 7-12см, туистери, джигове 10-20г — бяло/сребристо нощем, натурални цветове денем', rigs: 'Джиг монтаж, живца монтаж, подводна плувка' },
    },
    ecoRed: '⛔ Забранен: зависи от място',
  ...
  },
  {
    ...
    techniques: { lake: ['Спининг'], river: ['Спининг'] },
    techniqueData: {
      'Спининг': { bait: 'Малки рибки, живец', line_mm: 0.20, braid_mm: 0.10, hook_size: '4-8', lures: 'Блесни 10-20г, повърхностни воблери — сребристо/бяло', rigs: 'Спининг, повърхностно водене' },
    },
